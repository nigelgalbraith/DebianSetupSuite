# constants/UnattendedStandardConstants.py
...
JOBS_KEY       = "UnattendedStandard"
CONFIG_TYPE    = "unattendedStandard"
DEFAULT_CONFIG = "Default"
CONFIG_DOC     = "doc/UnattendedStandardDoc.json"
...
# === LOGGING ===
LOG_PREFIX      = "unattended_standard_job"
LOG_DIR         = Path.home() / "logs" / "unattended_standard"
LOGS_TO_KEEP    = 10
...
ACTIONS = {
    "_meta": {
        "title": "Unattended Standard",
    },
    "Run unattended standard": {
        "verb": "run unattended standard",
        "filter_status": None,
        "label": COMPLETE_LABEL,
        "prompt": "Run unattended standard setup? [y/n]: ",

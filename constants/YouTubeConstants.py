...
from modules.browser_utils import open_browser
...
ACTIONS = {
    ...
    "Open YouTube / Login": {
        ...
        "filter_status": None,
        "label": None,
        "prompt": "Open YouTube in Firefox to check/login to your account? [y/n]: ",
        "execute_state": "OPEN_YOUTUBE",
